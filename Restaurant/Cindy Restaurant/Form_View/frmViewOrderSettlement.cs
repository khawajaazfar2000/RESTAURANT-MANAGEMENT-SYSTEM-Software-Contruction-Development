...
namespace Cindy_Restaurant.Form_View
{
    public partial class frmViewOrderSettlement : Form
    {
        ...
        {
            Change1.Text = "Coca Cola";
            Change2.Text = "Soft Drink";
            Change3.Text = "Sprit";
            Change4.Text = "Fanta";
            Change5.Text = "Juice";
            Change6.Text = "Red Bull";
            Change7.Text = "Energy Drink";
            Change8.Text = "Red Apple";

            Change9.Text = "Big Apple";
        ...
        private void btnSettlement_Click(object sender, EventArgs e)
        {
           ...
           // //wait a bit
            ...
            DialogResult result = MessageBox.Show(askme, "Print Receipt", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
