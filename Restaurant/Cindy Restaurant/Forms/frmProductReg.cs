...
namespace Cindy_Restaurant.Forms
{
    public partial class frmProductReg : Form
    {
        ...
        private void CboProSubCate_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void TxtProdDecs_TextChanged(object sender, EventArgs e)
        {
        ...
        private void TxtTax3percsentage_TextChanged(object sender, EventArgs e)
        {

        }

        private void TxtTax2percsentage_TextChanged(object sender, EventArgs e)
        {
        ...
        private void TxtTax1percsentage_TextChanged(object sender, EventArgs e)
        {
        ...
        private void TxtTax3Amt_TextChanged(object sender, EventArgs e)
        {

        }

        private void TxtTax2Amt_TextChanged(object sender, EventArgs e)
        {

        }

        private void TxtTax1Amt_TextChanged(object sender, EventArgs e)
        {
